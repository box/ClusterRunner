...
class TestManagerConfigLoader(BaseUnitTestCase):
    ...
    def test_configure_default_sets_protocol_scheme_to_http(self):
        ...
        config_loader = ManagerConfigLoader()
    ...
    def test_configure_postload_sets_protocol_scheme_to_https(self):
        ...
        self.unpatch('app.util.conf.manager_config_loader.ManagerConfigLoader.load_from_config_file')
