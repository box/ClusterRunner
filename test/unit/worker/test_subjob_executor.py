...
class TestSubjobExecutor(BaseUnitTestCase):
    ...
    def test_configure_project_type_passes_project_type_params_and_calls_setup_executor(self):
        ...
        util = self.patch('app.worker.subjob_executor.util')
    ...
    def test_configure_project_type_with_existing_project_type_calls_teardown(self):
        ...
        self.patch('app.worker.subjob_executor.util')
    ...
    def test_execute_subjob_passes_correct_build_executor_index_to_execute_command_in_project(self):
        ...
        self.patch('app.worker.subjob_executor.fs_util')
        self.patch('app.worker.subjob_executor.shutil')
        output_file_mock = self.patch('app.worker.subjob_executor.open', new=mock_open(read_data=''), create=True).return_value
        os = self.patch('app.worker.subjob_executor.os')
        os.path = Mock()
