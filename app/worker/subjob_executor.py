...
from app.manager.build import BuildArtifact
...
class SubjobExecutor(object):
    """
    This class represents a worker executor, responsible for executing subjobs on a worker.
    """
    ...
    def execute_subjob(self, build_id, subjob_id, atomic_commands, base_executor_index):
        ...
        # Maintain a list of atom artifact directories for compression and sending back to manager
        atom_artifact_dirs = []
