...
from app.manager.atomizer import Atomizer
...
MAX_EXECUTORS_PER_SLAVE = 'max_executors_per_worker'
...
class JobConfig(object):
    ...
    def __init__(self, name, setup_build, teardown_build, command, atomizer, max_executors, max_executors_per_worker):
        """
        :type name: str
        ...
        :type max_executors_per_worker: int | None
        """
        self.name = name
        ...
        self.max_executors_per_worker = max_executors_per_worker
    ...
    def _unpack(cls, name, config_dict):
        ...
        max_executors_per_worker = config_dict.get(MAX_EXECUTORS_PER_SLAVE, cls.DEFAULT_MAX_EXECUTORS)
        return cls(name, setup_build, teardown_build, command, atomizer, max_executors, max_executors_per_worker)
