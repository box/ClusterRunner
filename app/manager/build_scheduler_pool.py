...
class BuildSchedulerPool(object):
    ...
    def __init__(self):
        ...
        self._builds_waiting_for_workers = Queue()
    ...
    def next_prepared_build_scheduler(self):
        ...
        :rtype: BuildScheduler
        """
        build = self._builds_waiting_for_workers.get()
        return self.get(build)

    def add_build_waiting_for_workers(self, build):
        """
        :type build: app.manager.build.Build
        """
        self._builds_waiting_for_workers.put(build)
